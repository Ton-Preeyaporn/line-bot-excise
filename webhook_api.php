...
$channelAccessToken = 'PJmHADx4he39TkXnHr35ZS1h8KZhb9jL+5blnRoeSyoMbc21FAtPCx8M5SW6QJNDgY4Go62TGe8AKSw7jouvCHnyngMBSDjxjhyvm3DwbHetE7+jczk8F4ZVEj6X6q0XfzrXvU9O/y8sfSf+WYEDYAdB04t89/1O/w1cDnyilFU='; // Access Token ค่าที่เราสร้างขึ้น
	...
	if ($event['type'] == 'message') 
	{
		if($event['message']['type'] == 'text')
		{
			...
			if($text == "@บอท" || $texts[0] == "@บอท"){
				...
				$reply_message .= "พิมพ์ว่า \"แสดงรายชื่อผู้เข้ารับการอบรมหลักสูตร Chatbot AI\"\n";
